  ...
  return (
    <>
      <div className="xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-1/2 w-full xl:h-full lg:h-full md:h-full sm:h-full h-1/2 pt-5  ">
        <div className=" xl:w-10/12 lg:w-10/12 md:w-10/12 sm:w-10/12 w-full h-full flex flex-col gap-2 justify-center xl:items-end lg:items-end md:items-end sm:items-end items-center xl:text-right lg:text-right md:text-right sm:text-right text-center">
      ...
      <div className=" xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-1/2 w-full xl:h-full lg:h-full md:h-full sm:h-full h-1/2 ">
        <img
          src="./img/salle1.jpg"
